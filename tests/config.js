module.exports = {
  TestUrl: process.env.TEST_E2E_URL || 'https://manage-case.demo.platform.hmcts.net/',
  TestManageOrgUrl: process.env.TEST_MO_E2E_URL || 'https://manage-org.demo.platform.hmcts.net/',
