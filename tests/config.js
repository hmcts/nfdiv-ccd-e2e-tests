module.exports = {
  ...
  //TestPathToRun: process.env.E2E_TEST_PATH || 'tests/nfdiv/nightly/verifyCWuploadConfidentialDoc.test.js',
  //TestPathToRun: process.env.E2E_TEST_PATH || 'tests/nfdiv/nightly/verifyCWreject.test.js',
  //TestPathToRun: process.env.E2E_TEST_PATH || 'tests/nfdiv/nightly/verifyBulkCase.test.js',
  TestPathToRun: process.env.E2E_TEST_PATH ||   'tests/nfdiv/nightly/verifyAwaitingPronouncement.test.js',
  //TestPathToRun: process.env.E2E_TEST_PATH || 'tests/nfdiv/nightly/verifyWithdrawn.test.js',
  // TestPathToRun: process.env.E2E_TEST_PATH || 'tests/nfdiv/nightly/verifyReissue.test.js',
  //TestPathToRun: process.env.E2E_TEST_PATH || 'tests/nfdiv/nightly/verifyServiceDecision.test.js',
  // TestPathToRun: process.env.E2E_TEST_PATH || 'tests/nfdiv/nightly/verifyBulkCase.test.js',
  //TestPathToRun: process.env.E2E_TEST_PATH || 'tests/nfdiv/nightly/verifyConfirmService.test.js',
  //TestPathToRun: process.env.E2E_TEST_PATH ||   'tests/nfdiv/nightly/hwfRefusedByCaseWorker.test.js',
  //TestPathToRun: process.env.E2E_TEST_PATH || 'tests/nfdiv/nightly/verifyDispensedOrder.test.js',
  ...
  TestEnvRespondentSol2User:'divorce_as_respondent_solicitor_02@mailinator.com',
  TestEnvRespondentSol2Password:'Testing1234',
