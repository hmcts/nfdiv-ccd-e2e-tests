module.exports = {
//  TestUrl: process.env.TEST_E2E_URL || 'https://xui-webapp-pr-1289.service.core-compute-preview.internal/',
  ...
  TestPathToRun: process.env.E2E_TEST_PATH || 'tests/nfdiv/nightly/shareACaseAndSubmitAoS.test.js',
