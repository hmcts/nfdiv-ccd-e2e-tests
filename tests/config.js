module.exports = {
  ...
  TestPathToRun: process.env.E2E_TEST_PATH ||   'tests/nfdiv/nightly/solicitorCreateJointDivorceApplication.test.js',
  //TestPathToRun: process.env.E2E_TEST_PATH ||   'tests/nfdiv/nightly/contionalOrderJourneys.test.js',
  //TestPathToRun: process.env.E2E_TEST_PATH ||   'tests/nfdiv/nightly/verifyAwaitingCOScriptOnly.test.js',
