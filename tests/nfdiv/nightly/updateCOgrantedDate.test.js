...
xScenario('NFD - Verify Bulk Case ', async function (I) {
  ...
  // console.log( '..... caseCreated in CCD , caseNumber is ==  ' + caseNumber);ccd-nfd-eligibledate.json

  // hack for arbitary caseId.
  await updateNFDCaseInCcd(user.CA,'1638964022539824', 'system-final-order-overdue','data/ccd-nfd-COgrantedDate.json');
