...
// TODO - ONLY FOR DEMO CASES , so commented out as It is NOT Run on Pipeline.

xScenario(' A JointApplication case is part of a BulkList', async (I) => {

  caseNumber = await createNFDCaseInCcd('data/ccd-nfdiv-demo-joint-draft-case.json');
  console.log( '..... Solicitor Joint  Created in CCD and the  CaseNumber is ==  ' + caseNumber);
